import 'package:digi_split/set_profile.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Your number is registered with us. Kindly Login from the main Page",
        style: TextStyle(
          fontFamily: "Teko",
  ...
  void signInWithPhoneAuthCredential(PhoneAuthCredential phoneAuthCredential) async {
    ...
    try {
      ...
      if(authCredential.user != null){
        if(await DataBase().check_existingusers(phone.text)==false)
          {
            SharedPreferences prefs= await SharedPreferences.getInstance();
            prefs.setString('phone', phone.text);
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> SetProfile(phone: phone.text)),(route) => false);
          }
        else
          {
